...
# based on https://github.com/jwilder/nginx-proxy/blob/3ef600a3b56105fa4ac343ef6d10b2c52818fec0/generate-dhparam.sh

# The first argument is the bit depth of the dhparam, or 2048 if unspecified
DHPARAM_BITS=${1:-4096}
DHPARAM_USEDSA=${2:-true}

# If a dhparam file is not available, use the pre-generated one and generate a new one in the background.
# Note that /etc/nginx/dhparam is a volume, so this dhparam will persist restarts.
PREGEN_DHPARAM_FILE="/etc/nginx/dhparam/dhparam.pem.default"
